...
control.prototype.resize = function() {
    ...
    if (clientWidth >= totalWidth || (clientWidth > clientHeight && clientHeight < totalHeight)) {
        // 横屏
        core.domStyle.isVertical = false;
        core.domStyle.scale = Math.min(1, clientHeight / totalHeight);
    }
    else {
        // 竖屏
        core.domStyle.isVertical = true;
        core.domStyle.scale = Math.min(1, clientWidth / totalHeight);
    }
